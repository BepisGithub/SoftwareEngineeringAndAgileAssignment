"""
Django settings for primeVideoReviewPlatform project.
...
SECRET_KEY = 'django-insecure-(iv3koe=i9_&8!6)z*ue&i1b%uvkxmwosp@x9gs2amx6jg!hm8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'https://softwareengineeringandagileassignment.onrender.com']
...
# Logging configuration to capture form errors
LOGGING = {
    'version': 1,
...
ROOT_URLCONF = 'primeVideoReviewPlatform.urls'
...
WSGI_APPLICATION = 'primeVideoReviewPlatform.wsgi.application'
